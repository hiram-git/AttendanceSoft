...
function ProfilePage() {
  ...
  return (
    <AppShell here="Perfil" crumbPath={['Cuenta', 'Perfil']}>
      <div className="page-head">
        <div>
          <h1>Tu perfil</h1>
          <div className="subtitle">
            Datos de la cuenta y preferencias de seguridad.
          </div>
        </div>
      </div>

      {isPending || !session ? (
        <div className="card" style={{ padding: 24, color: 'var(--app-muted)' }}>Cargando…</div>
      ) : (
        <div
          style={{
            display: 'grid',
